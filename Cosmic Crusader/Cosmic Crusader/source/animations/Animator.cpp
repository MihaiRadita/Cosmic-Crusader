...
namespace ratchet
{
	...
	void Animator::invertAnimation(AnimationBase* anim, Weapon::TYPE& weaponUsed, WeaponAnimation::ANGLE& angle, WeaponAnimation::STATE& state, bool invert)
	{
		anim->invertAnimationFramesList(weaponUsed, angle, state, invert);
	}
